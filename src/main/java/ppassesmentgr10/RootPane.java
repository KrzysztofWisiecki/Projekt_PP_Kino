...
public class RootPane extends Pane {
    ...
    private void initHallPanes() {
        hallPane1 = new Hall("TINKER TAILOR SOLDIER SPY");
        ...
        hallPane4 = new Hall("YOU WERE NEVER REALLY HERE");
    ...
    private void initHallButtons() {
        setHall1 = new Button("Seans 1");
        setHall2 = new Button("Seans 2");
        setHall3 = new Button("Seans 3");
        setHall4 = new Button("Seans 4");
